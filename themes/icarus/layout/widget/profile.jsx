        ...
        return <div class="card widget" data-type="profile">
            <div class="card-content">
                ...
                {followLink ? <div class="level">
                    <a class="level-item button is-primary is-rounded" style="background-color:#f14668e3;color:white;font-weight:bold;" href={followLink} target="_blank" rel="noopener">{followTitle}</a>
                </div> : null}
...
Profile.Cacheable = cacheComponent(Profile, 'widget.profile', props => {
    ...
    return {
        ...
        followTitle: "if 👍 then Buy me a Coffee",
        socialLinks
    };
});
